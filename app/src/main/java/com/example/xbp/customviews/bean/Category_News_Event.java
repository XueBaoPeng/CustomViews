 ...
 */
public class Category_News_Event {
    ...
    private List<TngouCategoryTitleEntity> tngou;
    ...
    public List<TngouCategoryTitleEntity> getTngou() {
        return tngou;
    }

    public void setTngou(List<TngouCategoryTitleEntity> tngou) {
        this.tngou = tngou;
    }

    public static class TngouCategoryTitleEntity {
