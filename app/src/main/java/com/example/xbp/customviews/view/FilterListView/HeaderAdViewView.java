...
import com.example.xbp.customviews.adapter.HeaderAdAdapter;
import com.example.xbp.customviews.manager.ImageManager;
import com.example.xbp.customviews.util.DensityUtil;
...
public class HeaderAdViewView extends HeaderViewInterface<List<String>> {
    ...
    protected void getView(List<String> strings, ListView listView) {
        ...
        dealWidthTheView(strings);
        listView.addHeaderView(view);
    }

    private void dealWidthTheView(List<String> list){
        ivList.clear();
        int size=list.size();
    ...
    private void addIndicatorImageView(int size){
